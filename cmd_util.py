...
from atari_wrappers import make_atari, wrap_deepmind, WarpFrame, MaxAndSkipEnv
...
def make_my_env(env_id, num_env, seed, wrapper_kwargs=None, start_index=0, max_episode_steps=4500):
    """
    Create a wrapped, monitored SubprocVecEnv for Atari.
    """
    if wrapper_kwargs is None: wrapper_kwargs = {}
